...
public class ProfessorDetailsFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        WebView webView = getView().findViewById(R.id.prof_webview);
        webView.loadUrl("https://www.hof-university.de/ueber-uns/personen/professoren/prof-dr-walter-kern.html");
    }
}